...
namespace UnitTests.ApplicationCore.OrderServiceTests
{
    public class CreateOrder
    {
        ...
        public async Task ShouldThrowEmptyBasketExceptionIfBasketIsEmpty()
        {
            ...
            //İddia ediyorum (assert) fırlatmalıdır (throw) EmptyBasketException hatası
            //orderService sınıfının CreateOrderAsync metodu boş sepete sahip bir kullanıcı için çağrıldığında
